...
- [#1435](https://github.com/request/request/pull/1435) dry up verb methods (@shardorapollack)
...
- [#249](https://github.com/request/request/pull/249) Fix for the fix of your (closed) issue #89 where self.headers[content-length] is set to 0 for all methods (@shardorabridges, @polotek, @zephrax, @jeromegn)
