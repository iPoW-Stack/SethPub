...
//     SETH_DEBUG("block.prehash(): %s, height: %lu, vss_random: %lu, "
...
//         SETH_DEBUG("add tx key: %s, %s, value: %s",
...
//     for (int32_t i = 0; i < tx_info.storages_size(); ++i) {
//         SETH_DEBUG("amount: %lu, gas_limit: %lu, gas_price: %lu, step: %u, key: %s, %s, val: %s, block tx hash: %s, message: %s",
