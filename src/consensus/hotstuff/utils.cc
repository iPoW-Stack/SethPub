...
std::string GetTxMessageHash(const block::protobuf::BlockTx& tx_info, const std::string& phash) {
    ...
    //     SETH_DEBUG("add tx key: %s, %s, val: %s",
    ...
    SETH_DEBUG("phash: %s, nonce: %lu, from: %s, to: %s, balance: %lu, amount: %lu, gas_limit: %lu, "
...
std::string GetBlockHash(const view_block::protobuf::ViewBlockItem &view_block) {
    ...
    // SETH_DEBUG("get block hash txs message: %s, vss_random: %lu, height: %lu, "
