...
inline ::google::protobuf::uint64 TxMessage::contract_prepayment() const {
  // @@protoc_insertion_point(field_get:seth.ws.protobuf.TxMessage.contract_prepayment)
...
inline void TxMessage::set_contract_prepayment(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:seth.ws.protobuf.TxMessage.contract_prepayment)
}
...
inline ::google::protobuf::uint64 C2cMessage::prepayment() const {
  // @@protoc_insertion_point(field_get:seth.ws.protobuf.C2cMessage.prepayment)
  return prepayment_;
}
inline void C2cMessage::set_prepayment(::google::protobuf::uint64 value) {
  set_has_prepayment();
  prepayment_ = value;
  // @@protoc_insertion_point(field_set:seth.ws.protobuf.C2cMessage.prepayment)
}
