node_ips=$1
cmd=$2
REMOTE_SSH_PORT="${SETH_REMOTE_SSH_PORT:-${REMOTE_SSH_PORT:-22}}"
REMOTE_SSH_PASSWORD="${SETH_REMOTE_PASSWORD:-${REMOTE_SSH_PASSWORD:-}}"
REMOTE_FAIL_FILE="${REMOTE_FAIL_FILE:-/tmp/seth_cmd_fail.$$}"
export SSHPASS="Xf4aGbTaYYY!"
REMOTE_PIDS=()
