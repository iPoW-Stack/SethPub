...
cp -rf ./zjnodes/seth/GeoLite2-City.mmdb ./docker_files/node/conf
cp -rf ./zjnodes/seth/conf/log4cpp.properties ./docker_files/node/conf
cp -rf ./cbuild_$target/seth ./docker_files/node
...
cp -rf /root/zjnodes/seth/root_db ./docker_files/node/
cp -rf /root/zjnodes/seth/shard_db_* ./docker_files/node/
