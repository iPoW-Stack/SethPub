...
cp -rf ./seths/seth/GeoLite2-City.mmdb ./docker_files/node/conf
cp -rf ./seths/seth/conf/log4cpp.properties ./docker_files/node/conf
...
cp -rf /root/seths/seth/root_db ./docker_files/node/
cp -rf /root/seths/seth/shard_db_* ./docker_files/node/
