...
**低门槛准入**：最低质押 8 SETH（8 × 10⁸ coins），无白名单。`start_miner.sh` 即可加入。
...
| 每 epoch 初始奖励 | 10,000 SETH | `kInitialTotalReward` |
| 减半周期 | 210,240 epochs（约 4 年） | `kHalvingPeriodEpochs` |
| 最低区块奖励 | 1 SETH | `kMinBlockReward` |
