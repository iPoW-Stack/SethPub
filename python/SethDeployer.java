...
/**
 * Seth Native Deployer
 * ====================
 * Deploys contracts using Seth's native /transaction API instead of
 * eth_sendRawTransaction. This matches the protocol used by seth_sdk.py.
 *
 * Seth differences from Ethereum:
...
public class SethDeployer {
    ...
    // Seth step types (from seth_sdk.py StepType)
    ...
    /**
     * Deploy a contract using Seth's native protocol:
    ...
    // ─── Seth Native Transaction ─────────────────────────────────────────

    /**
     * Build the Seth transaction hash, sign it, and POST to /transaction.
     * Returns the hex-encoded tx hash.
     *
     * Hash preimage (matching seth_sdk.py send_transaction_auto):
    ...
    /** Derive Seth address: keccak256(pubkey_64bytes)[-20:] */
    ...
    private static String toChecksumAddr(String addr) {
        // Seth uses lowercase 40-char hex addresses
